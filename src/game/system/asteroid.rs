...
use crate::{game::components::{Asteroid, GameState}, global::component::GameObject};

use super::utils::normalize_coords_in_window;

pub fn spawn_asteroid(mut commands: Commands,  windows: Query<&Window, With<PrimaryWindow>>, asset_server: Res<AssetServer>) {
